...
country.list          <- list()
  ...
  for (i in sexes){
    ...
    for (j in countries2){
      ...
      Decomp.list <- mclapply(years,function(yr,y,z,sdfrommxc,i){
        ...
        contrib },y= y,z=z,sdfrommxc = sdfrommxc, i = i, mc.cores = 4)
...
save(Decomp.results.sd, file =  'Data/Compare_DecompResults_sd_List.RData')
gc()
