...
ICD7    <- data.table(read.table(  file = paste0(datadir,'/MortIcd7.txt'),header = T,sep = ',',stringsAsFactors = F))
ICD7    <- ICD7[(ICD7$Country==4050 | ICD7$Country==4290 | ICD7$Country==4220) & ICD7$Year >= 1960,]
ICD7$ICD<- 7
# Information for ICD8
ICD8    <- data.table(read.table(  file = paste0(datadir,'/MortIcd8.txt'),header = T,sep = ',',stringsAsFactors = F))
