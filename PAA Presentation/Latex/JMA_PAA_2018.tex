...
\Large{
		...
		\item<2-> Females born in 1919-1939 $\longrightarrow$ \textbf{high levels of smoking and alcohol consumption}.
		
		\item<3-> \textbf{Highest} lung cancer mortality rates in Europe.
		
        \item<4-> Males have \textbf{higher smoking-related mortality} than Swedish (snus vs tobacco).

        \item<5-> Denmark showed the \bf{highest} mortality from all neoplasms in Europe.
